                ...
                <table class="table mt-4">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th colspan="1"></th>
                            <th colspan="1">
                                <input type="text" id="Listfilter-Name" size="12" class="form-control" style="width:100%;" value="{{$aFilter['name']}}" />
                            </th>
                            <th colspan="1">
                                ...
                                <form action="{{route('item.index')}}" method="GET" id="frmListFilter">
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            ...
                                            $('#Listfilter-Name').keyup(function (e) {
                                                $('#frmName').val($('#Listfilter-Name').val());
                                                if (e.key === 'Enter') {
                                                    $('#frmListFilter').submit();
                                                }
                                            });
                                    ...
                                    <input type="hidden" name="name" id="frmName" value="{{$aFilter['name']}}" />
